...
class OneUser extends React.Component {
    ...
    componentDidMount() {
        if (this.props.user.userType === 'DELIVERER_USER') {
            this.setState({
    ...
    updateUser() {
        if (this.props.user.userType === 'CUSTOMER_USER' || this.props.user.userType
                                                                    === 'OWNER_USER') {
            let user = {
        ...
        } else if (this.props.user.userType === 'DELIVERER_USER') {
            let user = {
                id: this.props.user.id,
                username: this.state.username,
                email: this.state.email,
    ...
    render() {
        if (this.props.user.userType === 'ADMIN_USER') {
            return null;
        } else {
            return (
                <div className="card">
                    ...
                    <div id={this.props.user.id.toString()} className={this.state.status}
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                {
                                    this.props.user.userType === 'DELIVERER_USER' &&
                                    <div className="form-group row">
                                        <label htmlFor="car"

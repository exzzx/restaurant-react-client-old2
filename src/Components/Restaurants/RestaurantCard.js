        ...
        return (
            <div className="col-sm-3">
                <div className="card bg-light mb-3">
                    <img className="card-img-top" src={this.props.res.photoLink && this.props.res.photoLink.length !== 0 ? this.props.res.photoLink : "https://s3-media2.fl.yelpcdn.com/bphoto/AfzWBQYFuCvP1gHZ5aUccw/o.jpg"} alt="Cover picture is coming..."/>
                    ...
                    {
                        <div className="card-body">
                            <button onClick={this.findDetailsByRestaurantId}
